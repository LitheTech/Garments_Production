...
class Override_JobCard(Document):
	...
	def validate(self):
		...
		'''
		Commented out the validate_sequence_id to avoid operation validation in job cards.
		'''
...
def make_time_log(args):
	...
	# doc.validate_sequence_id() commented 9/7/25 to override this validation
